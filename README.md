...
wget https://github.com/MarcelineVPQ/oxitailr/releases/download/v0.2.17/Oxitailr-0.2.17-x86_64.AppImage

# Make executable
chmod +x Oxitailr-0.2.17-x86_64.AppImage

# Run
./Oxitailr-0.2.17-x86_64.AppImage
```
